...
$galfit_output = "c:\Users\lenovo\Desktop\FRB-capstone\NGC_4762_Analysis\Science_Output\NGC_4762_galfit_nopsf.fits"
...
Write-Host "Opening NGC 4762 Results in DS9..."
