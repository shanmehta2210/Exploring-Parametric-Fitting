...
$galfit_output = "c:\Users\lenovo\Desktop\FRB-capstone\NGC_3245_Analysis\Science_Output\NGC_3245_galfit_nopsf.fits"
...
Write-Host "Opening NGC 3245 Results in DS9..."
