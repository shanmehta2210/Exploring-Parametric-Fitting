...
$galfit_output = "c:\Users\lenovo\Desktop\FRB-capstone\NGC_5576_Analysis\Science_Output\NGC_5576_galfit_nopsf.fits"
...
Write-Host "Opening NGC 5576 Results in DS9..."
