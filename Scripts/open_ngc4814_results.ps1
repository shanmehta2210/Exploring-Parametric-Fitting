...
$galfit_output = "c:\Users\lenovo\Desktop\FRB-capstone\NGC_4814_Analysis\Science_Output\NGC_4814_galfit_nopsf.fits"
...
Write-Host "Opening NGC 4814 Results in DS9..."
