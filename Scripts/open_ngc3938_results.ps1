...
$galfit_output = "c:\Users\lenovo\Desktop\FRB-capstone\NGC_3938_Analysis\Science_Output\NGC_3938_galfit_nopsf.fits"
...
Write-Host "Opening NGC 3938 Results in DS9..."
